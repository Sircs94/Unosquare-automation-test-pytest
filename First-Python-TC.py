...
if driver.find_element_by_xpath("//div[@class='hs_name hs-name hs-fieldtype-text field hs-form-field']//label[@class='hs-error-msg'][normalize-space()='Please complete this required field.']").is_displayed():
    print("Name Complete field warning was found")

else:
    print("Name Complete field warning not found")

if driver.find_element_by_xpath("//div[@class='hs_email hs-email hs-fieldtype-text field hs-form-field']//label[@class='hs-error-msg'][normalize-space()='Please complete this required field.']").is_displayed():
...
driver.find_element_by_xpath("//input[@id='email-2a32df81-981f-4329-b943-9f2e76efe5f0']").send_keys("Sergio@gmail.com")
...
lista = []
lista.insert(0, driver.find_element_by_xpath("//header/div[3]/div[1]/div[2]/main[1]/section[1]/div[1]/div[1]/a[1]").text)
lista.insert(1, driver.find_element_by_xpath("//header/div[3]/div[1]/div[2]/main[1]/section[1]/div[2]/div[1]/a[1]").text)
lista.insert(2, driver.find_element_by_xpath("//header/div[3]/div[1]/div[2]/main[1]/section[1]/div[3]/div[1]/a[1]").text)
lista.insert(3, driver.find_element_by_xpath("//header/div[3]/div[1]/div[2]/main[1]/section[1]/div[4]/div[1]/a[1]").text)
lista.insert(4, driver.find_element_by_xpath("//header/div[3]/div[1]/div[2]/main[1]/section[1]/div[5]/div[1]/a[1]").text)
